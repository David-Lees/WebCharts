...
namespace WebCharts.Services
{
    ...
    internal interface IChartRenderingEngine
    {
        ...
        void DrawLine(SKPaint pen, SKPoint pt1, SKPoint pt2);
        ...
        void DrawImage(SKImage image, SKRect destRect, int srcX, int srcY, int srcWidth, int srcHeight, SKPaint paint);
        ...
        void DrawEllipse(SKPaint pen, float x, float y, float width, float height);
        ...
        void DrawRectangle(SKPaint pen, int x, int y, int width, int height);
        ...
        void DrawRectangle(SKPaint pen, float x, float y, float width, float height);
        ...
        void DrawString(string s, SKFont font, SKPaint brush, SKRect layoutRectangle);
        ...
        void DrawString(string s, SKFont font, SKPaint brush, SKPoint point);
        ...
        void DrawPath(SKPaint pen, SKPath path);
