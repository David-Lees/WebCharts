...
namespace WebCharts.Services.Models.ChartTypes
{
	...
	internal class BarChart : IChartType
	{
		...
		#region IChartType interface implementation
			...
			virtual public Stream GetImage(ChartTypeRegistry registry)
			{
				return (Stream)registry.ResourceManager.GetObject(this.Name + "ChartType");
			}
					...
					else
					{
                        ...
                        while (!labelFit)
                        {
                            ...
                            if (barStartPosition <= barSize)
                            {
                                ...
                                {
                                    rectLabel.Right = rectSize.Left + area.PlotAreaPosition.Left;
                                    rectLabel.Left = area.PlotAreaPosition.Left;
                                }
                            }
                            else
                            {
