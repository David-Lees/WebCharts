...
namespace WebCharts.Services
{
    ...
    internal class HundredPercentStackedAreaChart : StackedAreaChart
    {
        ...
        private double[] _totalPerPoint = null;
    ...
    internal class StackedAreaChart : AreaChart
    {
        ...
        /// </summary>
        protected SKPath areaBottomPath = new();
            ...
            Series seriesToDraw)
        {
            ...
            foreach (Series ser in common.DataManager.Series)
            {
                ...
                SKPoint secondPoint = SKPoint.Empty;
                foreach (DataPoint point in ser.Points)
                {
                    ...
                    if (firstPoint == SKPoint.Empty)
                    {
                        ...
                        if (prevPointsArray != null && index < prevPointsArray.Count)
                        {
                            ...
                            prevYValue1 = graph.GetAbsolutePoint(new SKPoint(prevYValue1, prevYValue1)).Y;
                        }
                    ...
                    else
                    {
                        ...
                        if (prevPointsArray != null && index < prevPointsArray.Count)
                        {
                            ...
                            prevYValue2 = graph.GetAbsolutePoint(new SKPoint(prevYValue2, prevYValue2)).Y;
                        }
            ...
            float depth)
        {
                ...
                (pointShowLabelAsValue || pointLabel.Length > 0))
            {
                ...
                sizeLabel.Width += sizeLabel.Width / text.Length;
                labelBackPosition = new SKRect(
                    points[0].SKPoint.X - sizeLabel.Width / 2,
                    points[0].SKPoint.Y - sizeLabel.Height / 2 - SKSizeont.Height / 10,
                    sizeLabel.Width,
                    sizeLabel.Height);
