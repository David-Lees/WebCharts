...
namespace WebCharts.Services.Models.ChartTypes
{
	...
	internal class PointChart : IChartType
	{
		...
		private void SetHotRegions(CommonElements common, ChartGraphics graph, DataPoint point, SKSize markerSize, string seriesName, int pointIndex, MarkerStyle pointMarkerStyle, SKPoint markerPosition)
		{
