...
namespace WebCharts.Services.Models.General
{
    ...
    public class AxisScaleBreakStyle
    {
        ...
        // Break line color
        private SKColor _breakLineColor = SKColors.Black;
        ...
        public int CollapsibleSpaceThreshold
        {
            get
            {
                return _minimumNumberOfEmptySegments;
            }
            set
            {
                ...
                _minimumNumberOfEmptySegments = value;
                Invalidate();
            }
        }
        ...
        public BreakLineStyle BreakLineStyle
        {
            get
            {
                return _breakLineStyle;
            }
            set
            {
                _breakLineStyle = value;
                Invalidate();
            }
        }
        ...
        public SKColor LineColor
        {
            get
            {
                return _breakLineColor;
            }
            set
            {
                _breakLineColor = value;
                Invalidate();
            }
        }
        ...
        public ChartDashStyle LineDashStyle
        {
            get
            {
                return _breakLineDashStyle;
            }
            set
            {
                _breakLineDashStyle = value;
                Invalidate();
            }
        }
        ...
        private void SetAxisSegmentPosition(AxisScaleSegmentCollection axisSegments)
        {
            ...
            foreach (AxisScaleSegment axisScaleSegment in axisSegments)
            {
                if (axisScaleSegment.Tag is int integer)
                {
                    totalPointNumber += integer;
                }
            }
            ...
            for (int index = 0; index < axisSegments.Count; index++)
            {
                ...
                {
                    axisSegments[index].Spacing = _segmentSpacing;
                }
        ...
        private void FillAxisSegmentCollection(AxisScaleSegmentCollection axisSegments)
        {
            ...
            while (!doneFlag)
            {
                ...
                int minEmptySegments = (int)(_minimumNumberOfEmptySegments * (100.0 / dataRangePercent));
                ...
                if ((axisSegments.Count - 1) >= _maximumNumberOfBreaks)
                {
                    doneFlag = true;
                }
            }
        ...
        private static bool IsExcludedSegment(ArrayList excludedSegments, int segmentIndex)
        {
