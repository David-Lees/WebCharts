...
namespace WebCharts.Services.Models.General
{
    ...
    internal class ChartImage : ChartPicture
	{
        ...
        public Bitmap GetImage(float resolution)
		{
            ...
            if (this.BackColor != SKColor.Empty)
    ...
    internal class ChartPicture : ChartElement, IServiceProvider
	{
		...
		public void Resize(ChartGraphics chartGraph, bool calcAreaPositionOnly)
		{
			...
			SKRect	chartAreasRectangle = new SKRect(0, 0, _width - 1, _height - 1);
			...
			if(titleInBorder)
			{
				frameTitlePosition = new SKRect(_titlePosition.Location, _titlePosition.Size);
			}
