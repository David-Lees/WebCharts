...
namespace WebCharts.Services.Models.General
{
    ...
    internal class Matrix3D
    {
            ...
            bool rightAngleAxis)
        {
            ...
            _translateX = innerPlotRectangle.Left + innerPlotRectangle.Width / 2;
            _translateY = innerPlotRectangle.Top + innerPlotRectangle.Height / 2;
        ...
        private void RightAngleProjection(Point3D[] points)
        {
            ...
            float xFactor = _angleX / 45;

            float yFactor;

            if (_angleY >= 45)
            {
                yFactor = (_angleY - 90) / coorectionAngle;
            }
            else if (_angleY <= -45)
            {
                yFactor = (_angleY + 90) / coorectionAngle;
            ...
            {
                yFactor = _angleY / coorectionAngle;
            }
