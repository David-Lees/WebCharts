...
namespace WebCharts.Services.Models.Utilities
{
    ...
    internal class ImageLoader : IDisposable, IServiceProvider
	{
        ...
        private SKImage LoadFromFile(string fileName)
		{
        ...
        //internal static bool DoDpisMatch(SKImage image, Graphics graphics)
        //{
        //    return graphics.DpiX == image.HorizontalResolution && graphics.DpiY == image.VerticalResolution;
        //}

        //internal static SKImage GetScaledImage(SKImage image, Graphics graphics)
        //{
